    ...
    impl ::protobuf::Enum for Reason {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Reason> {
            match str {
                ...
                "ProtocolVersionMismatch" => ::std::option::Option::Some(Reason::ProtocolVersionMismatch),
                "GenesisMismatch" => ::std::option::Option::Some(Reason::GenesisMismatch),
                "InvalidTarget" => ::std::option::Option::Some(Reason::InvalidTarget),
                _ => ::std::option::Option::None
            }
        }
...
// @@protoc_insertion_point(message:network.AdvertisedPeerDistance)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct AdvertisedPeerDistance {
    // message fields
    // @@protoc_insertion_point(field:network.AdvertisedPeerDistance.destination)
    pub destination: ::protobuf::MessageField<PublicKey>,
    // @@protoc_insertion_point(field:network.AdvertisedPeerDistance.distance)
    pub distance: u32,
    // special fields
    // @@protoc_insertion_point(special_field:network.AdvertisedPeerDistance.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a AdvertisedPeerDistance {
    fn default() -> &'a AdvertisedPeerDistance {
        <AdvertisedPeerDistance as ::protobuf::Message>::default_instance()
    }
}

impl AdvertisedPeerDistance {
    pub fn new() -> AdvertisedPeerDistance {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, PublicKey>(
            "destination",
            |m: &AdvertisedPeerDistance| { &m.destination },
            |m: &mut AdvertisedPeerDistance| { &mut m.destination },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "distance",
            |m: &AdvertisedPeerDistance| { &m.distance },
            |m: &mut AdvertisedPeerDistance| { &mut m.distance },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<AdvertisedPeerDistance>(
...
impl ::protobuf::Message for AdvertisedPeerDistance {
    const NAME: &'static str = "AdvertisedPeerDistance";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.distance != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.distance);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.distance != 0 {
            os.write_uint32(2, self.distance)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn new() -> AdvertisedPeerDistance {
        AdvertisedPeerDistance::new()
    }
    ...
    fn default_instance() -> &'static AdvertisedPeerDistance {
        static instance: AdvertisedPeerDistance = AdvertisedPeerDistance {
...
impl ::protobuf::MessageFull for AdvertisedPeerDistance {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("AdvertisedPeerDistance").unwrap()).clone()
    }
}

impl ::std::fmt::Display for AdvertisedPeerDistance {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for AdvertisedPeerDistance {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}

// @@protoc_insertion_point(message:network.DistanceVector)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct DistanceVector {
    // message fields
    // @@protoc_insertion_point(field:network.DistanceVector.root)
    pub root: ::protobuf::MessageField<PublicKey>,
    // @@protoc_insertion_point(field:network.DistanceVector.distances)
    pub distances: ::std::vec::Vec<AdvertisedPeerDistance>,
    // @@protoc_insertion_point(field:network.DistanceVector.edges)
    pub edges: ::std::vec::Vec<Edge>,
    // special fields
    // @@protoc_insertion_point(special_field:network.DistanceVector.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a DistanceVector {
    fn default() -> &'a DistanceVector {
        <DistanceVector as ::protobuf::Message>::default_instance()
    }
}

impl DistanceVector {
    pub fn new() -> DistanceVector {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, PublicKey>(
            "root",
            |m: &DistanceVector| { &m.root },
            |m: &mut DistanceVector| { &mut m.root },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "distances",
            |m: &DistanceVector| { &m.distances },
            |m: &mut DistanceVector| { &mut m.distances },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "edges",
            |m: &DistanceVector| { &m.edges },
            |m: &mut DistanceVector| { &mut m.edges },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<DistanceVector>(
            "DistanceVector",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for DistanceVector {
    const NAME: &'static str = "DistanceVector";
    ...
    fn default_instance() -> &'static DistanceVector {
        static instance: DistanceVector = DistanceVector {
...
impl ::protobuf::MessageFull for DistanceVector {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("DistanceVector").unwrap()).clone()
    }
}

impl ::std::fmt::Display for DistanceVector {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for DistanceVector {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
pub mod trace_context {
    ...
    impl ::protobuf::Enum for SamplingPriority {
        ...
        fn from_str(str: &str) -> ::std::option::Option<SamplingPriority> {
            match str {
                "UNKNOWN" => ::std::option::Option::Some(SamplingPriority::UNKNOWN),
                "AutoReject" => ::std::option::Option::Some(SamplingPriority::AutoReject),
                "UserReject" => ::std::option::Option::Some(SamplingPriority::UserReject),
                "AutoKeep" => ::std::option::Option::Some(SamplingPriority::AutoKeep),
                "UserKeep" => ::std::option::Option::Some(SamplingPriority::UserKeep),
                _ => ::std::option::Option::None
            }
        }
...
impl PeerMessage {
    ...
    // .network.DistanceVector distance_vector = 28;

    pub fn distance_vector(&self) -> &DistanceVector {
        match self.message_type {
            ::std::option::Option::Some(peer_message::Message_type::DistanceVector(ref v)) => v,
            _ => <DistanceVector as ::protobuf::Message>::default_instance(),
        }
    }

    pub fn clear_distance_vector(&mut self) {
        self.message_type = ::std::option::Option::None;
    }

    pub fn has_distance_vector(&self) -> bool {
        match self.message_type {
            ::std::option::Option::Some(peer_message::Message_type::DistanceVector(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_distance_vector(&mut self, v: DistanceVector) {
        self.message_type = ::std::option::Option::Some(peer_message::Message_type::DistanceVector(v))
    }

    // Mutable pointer to the field.
    pub fn mut_distance_vector(&mut self) -> &mut DistanceVector {
        if let ::std::option::Option::Some(peer_message::Message_type::DistanceVector(_)) = self.message_type {
        } else {
            self.message_type = ::std::option::Option::Some(peer_message::Message_type::DistanceVector(DistanceVector::new()));
        }
        match self.message_type {
            ::std::option::Option::Some(peer_message::Message_type::DistanceVector(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_distance_vector(&mut self) -> DistanceVector {
        if self.has_distance_vector() {
            match self.message_type.take() {
                ::std::option::Option::Some(peer_message::Message_type::DistanceVector(v)) => v,
                _ => panic!(),
            }
        } else {
            DistanceVector::new()
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, DistanceVector>(
            "distance_vector",
            PeerMessage::has_distance_vector,
            PeerMessage::distance_vector,
            PeerMessage::mut_distance_vector,
            PeerMessage::set_distance_vector,
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                226 => {
                    self.message_type = ::std::option::Option::Some(peer_message::Message_type::DistanceVector(is.read_message()?));
                },
                66 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let ::std::option::Option::Some(ref v) = self.message_type {
            match v {
                ...
                &peer_message::Message_type::DistanceVector(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
...
pub mod peer_message {
    ...
    pub enum Message_type {
        ...
        // @@protoc_insertion_point(oneof_field:network.PeerMessage.distance_vector)
        DistanceVector(super::DistanceVector),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x13proto/network.proto\x12\x07network\x1a\x1fgoogle/protobuf/timestam\
    p.proto\"\xaa\x01\n\x0cOwnedAccount\x123\n\x0baccount_key\x18\x01\x20\
    \x01(\x0b2\x12.network.PublicKeyR\naccountKey\x12+\n\x07peer_id\x18\x02\
    \x20\x01(\x0b2\x12.network.PublicKeyR\x06peerId\x128\n\ttimestamp\x18\
    \x03\x20\x01(\x0b2\x1a.google.protobuf.TimestampR\ttimestamp\"\xa2\x01\n\
    \x11AccountKeyPayload\x129\n\x0caccount_data\x18\x02\x20\x01(\x0b2\x14.n\
    etwork.AccountDataH\0R\x0baccountData\x12<\n\rowned_account\x18\x03\x20\
    \x01(\x0b2\x15.network.OwnedAccountH\0R\x0cownedAccountB\x0e\n\x0cpayloa\
    d_typeJ\x04\x08\x01\x10\x02\"!\n\tSignature\x12\x14\n\x05borsh\x18\x01\
    \x20\x01(\x0cR\x05borsh\"e\n\x17AccountKeySignedPayload\x12\x18\n\x07pay\
    load\x18\x01\x20\x01(\x0cR\x07payload\x120\n\tsignature\x18\x02\x20\x01(\
    \x0b2\x12.network.SignatureR\tsignature\"!\n\tPublicKey\x12\x14\n\x05bor\
    sh\x18\x01\x20\x01(\x0cR\x05borsh\"\x20\n\x08PeerInfo\x12\x14\n\x05borsh\
    \x18\x01\x20\x01(\x0cR\x05borsh\"\x20\n\nCryptoHash\x12\x12\n\x04hash\
    \x18\x01\x20\x01(\x0cR\x04hash\"\x1c\n\x04Edge\x12\x14\n\x05borsh\x18\
    \x01\x20\x01(\x0cR\x05borsh\"'\n\x0fPartialEdgeInfo\x12\x14\n\x05borsh\
    \x18\x01\x20\x01(\x0cR\x05borsh\"'\n\x0fAnnounceAccount\x12\x14\n\x05bor\
    sh\x18\x01\x20\x01(\x0cR\x05borsh\"\x1d\n\x05Block\x12\x14\n\x05borsh\
    ...
    \x18\x01\x20\x01(\x0e2\x20.network.HandshakeFailure.ReasonR\x06reason\
    \x12.\n\tpeer_info\x18\x02\x20\x01(\x0b2\x11.network.PeerInfoR\x08peerIn\
    fo\x121\n\ngenesis_id\x18\x03\x20\x01(\x0b2\x12.network.GenesisIdR\tgene\
    sisId\x12\x18\n\x07version\x18\x04\x20\x01(\rR\x07version\x128\n\x18olde\
    st_supported_version\x18\x05\x20\x01(\rR\x16oldestSupportedVersion\"Z\n\
    \x06Reason\x12\x0b\n\x07UNKNOWN\x10\0\x12\x1b\n\x17ProtocolVersionMismat\
    ch\x10\x01\x12\x13\n\x0fGenesisMismatch\x10\x02\x12\x11\n\rInvalidTarget\
    \x10\x03\"-\n\x08LastEdge\x12!\n\x04edge\x18\x01\x20\x01(\x0b2\r.network\
    .EdgeR\x04edge\"0\n\nSocketAddr\x12\x0e\n\x02ip\x18\x01\x20\x01(\x0cR\
    \x02ip\x12\x12\n\x04port\x18\x02\x20\x01(\rR\x04port\"`\n\x08PeerAddr\
    \x12'\n\x04addr\x18\x01\x20\x01(\x0b2\x13.network.SocketAddrR\x04addr\
    \x12+\n\x07peer_id\x18\x02\x20\x01(\x0b2\x12.network.PublicKeyR\x06peerI\
    d\"\xfc\x01\n\x0bAccountData\x12+\n\x07peer_id\x18\x05\x20\x01(\x0b2\x12\
    .network.PublicKeyR\x06peerId\x123\n\x0baccount_key\x18\x06\x20\x01(\x0b\
    2\x12.network.PublicKeyR\naccountKey\x12+\n\x07proxies\x18\x02\x20\x03(\
    \x0b2\x11.network.PeerAddrR\x07proxies\x12\x18\n\x07version\x18\x07\x20\
    \x01(\x04R\x07version\x128\n\ttimestamp\x18\x04\x20\x01(\x0b2\x1a.google\
    .protobuf.TimestampR\ttimestampJ\x04\x08\x01\x10\x02J\x04\x08\x03\x10\
    \x04\"{\n\x12RoutingTableUpdate\x12#\n\x05edges\x18\x01\x20\x03(\x0b2\r.\
    network.EdgeR\x05edges\x124\n\x08accounts\x18\x02\x20\x03(\x0b2\x18.netw\
    ork.AnnounceAccountR\x08accountsJ\x04\x08\x03\x10\x04J\x04\x08\x04\x10\
    \x05\"j\n\x16AdvertisedPeerDistance\x124\n\x0bdestination\x18\x01\x20\
    \x01(\x0b2\x12.network.PublicKeyR\x0bdestination\x12\x1a\n\x08distance\
    \x18\x02\x20\x01(\rR\x08distance\"\x9c\x01\n\x0eDistanceVector\x12&\n\
    \x04root\x18\x01\x20\x01(\x0b2\x12.network.PublicKeyR\x04root\x12=\n\tdi\
    stances\x18\x02\x20\x03(\x0b2\x1f.network.AdvertisedPeerDistanceR\tdista\
    nces\x12#\n\x05edges\x18\x03\x20\x03(\x0b2\r.network.EdgeR\x05edges\"Z\n\
    \x12UpdateNonceRequest\x12D\n\x11partial_edge_info\x18\x01\x20\x01(\x0b2\
    \x18.network.PartialEdgeInfoR\x0fpartialEdgeInfo\"8\n\x13UpdateNonceResp\
    onse\x12!\n\x04edge\x18\x01\x20\x01(\x0b2\r.network.EdgeR\x04edge\"\xad\
    \x01\n\x10SyncAccountsData\x12E\n\raccounts_data\x18\x01\x20\x03(\x0b2\
    \x20.network.AccountKeySignedPayloadR\x0caccountsData\x12\x20\n\x0bincre\
    mental\x18\x02\x20\x01(\x08R\x0bincremental\x120\n\x14requesting_full_sy\
    nc\x18\x03\x20\x01(\x08R\x12requestingFullSync\"\x82\x01\n\x0cPeersReque\
    st\x12\x20\n\tmax_peers\x18\x01\x20\x01(\rH\0R\x08maxPeers\x88\x01\x01\
    \x12-\n\x10max_direct_peers\x18\x02\x20\x01(\rH\x01R\x0emaxDirectPeers\
    \x88\x01\x01B\x0c\n\n_max_peersB\x13\n\x11_max_direct_peers\"n\n\rPeersR\
    esponse\x12'\n\x05peers\x18\x01\x20\x03(\x0b2\x11.network.PeerInfoR\x05p\
    eers\x124\n\x0cdirect_peers\x18\x02\x20\x03(\x0b2\x11.network.PeerInfoR\
    \x0bdirectPeers\"M\n\x13BlockHeadersRequest\x126\n\x0cblock_hashes\x18\
    \x01\x20\x03(\x0b2\x13.network.CryptoHashR\x0bblockHashes\"Q\n\x14BlockH\
    eadersResponse\x129\n\rblock_headers\x18\x01\x20\x03(\x0b2\x14.network.B\
    lockHeaderR\x0cblockHeaders\"B\n\x0cBlockRequest\x122\n\nblock_hash\x18\
    \x01\x20\x01(\x0b2\x13.network.CryptoHashR\tblockHash\"5\n\rBlockRespons\
    e\x12$\n\x05block\x18\x01\x20\x01(\x0b2\x0e.network.BlockR\x05block\")\n\
    \x11SignedTransaction\x12\x14\n\x05borsh\x18\x01\x20\x01(\x0cR\x05borsh\
    \"\x8d\x01\n\rRoutedMessage\x12\x14\n\x05borsh\x18\x01\x20\x01(\x0cR\x05\
    borsh\x129\n\ncreated_at\x18\x02\x20\x01(\x0b2\x1a.google.protobuf.Times\
    tampR\tcreatedAt\x12\x1e\n\x08num_hops\x18\x03\x20\x01(\x05H\0R\x07numHo\
    ps\x88\x01\x01B\x0b\n\t_num_hops\"M\n\nDisconnect\x12?\n\x1cremove_from_\
    connection_store\x18\x01\x20\x01(\x08R\x19removeFromConnectionStore\"!\n\
    \tChallenge\x12\x14\n\x05borsh\x18\x01\x20\x01(\x0cR\x05borsh\"%\n\rRout\
    ...
    _priority\x18\x03\x20\x01(\x0e2&.network.TraceContext.SamplingPriorityR\
    \x10samplingPriority\"[\n\x10SamplingPriority\x12\x0b\n\x07UNKNOWN\x10\0\
    \x12\x0e\n\nAutoReject\x10\x01\x12\x0e\n\nUserReject\x10\x02\x12\x0c\n\
    \x08AutoKeep\x10\x03\x12\x0c\n\x08UserKeep\x10\x04\"\x8a\x0b\n\x0bPeerMe\
    ssage\x12:\n\rtrace_context\x18\x1a\x20\x01(\x0b2\x15.network.TraceConte\
    xtR\x0ctraceContext\x12=\n\x0ftier1_handshake\x18\x1b\x20\x01(\x0b2\x12.\
    network.HandshakeH\0R\x0etier1Handshake\x12=\n\x0ftier2_handshake\x18\
    \x04\x20\x01(\x0b2\x12.network.HandshakeH\0R\x0etier2Handshake\x12H\n\
    \x11handshake_failure\x18\x05\x20\x01(\x0b2\x19.network.HandshakeFailure\
    H\0R\x10handshakeFailure\x120\n\tlast_edge\x18\x06\x20\x01(\x0b2\x11.net\
    work.LastEdgeH\0R\x08lastEdge\x12K\n\x12sync_routing_table\x18\x07\x20\
    \x01(\x0b2\x1b.network.RoutingTableUpdateH\0R\x10syncRoutingTable\x12B\n\
    \x0fdistance_vector\x18\x1c\x20\x01(\x0b2\x17.network.DistanceVectorH\0R\
    \x0edistanceVector\x12O\n\x14update_nonce_request\x18\x08\x20\x01(\x0b2\
    \x1b.network.UpdateNonceRequestH\0R\x12updateNonceRequest\x12R\n\x15upda\
    te_nonce_response\x18\t\x20\x01(\x0b2\x1c.network.UpdateNonceResponseH\0\
    R\x13updateNonceResponse\x12I\n\x12sync_accounts_data\x18\x19\x20\x01(\
    \x0b2\x19.network.SyncAccountsDataH\0R\x10syncAccountsData\x12<\n\rpeers\
    _request\x18\n\x20\x01(\x0b2\x15.network.PeersRequestH\0R\x0cpeersReques\
    t\x12?\n\x0epeers_response\x18\x0b\x20\x01(\x0b2\x16.network.PeersRespon\
    seH\0R\rpeersResponse\x12R\n\x15block_headers_request\x18\x0c\x20\x01(\
    \x0b2\x1c.network.BlockHeadersRequestH\0R\x13blockHeadersRequest\x12U\n\
    \x16block_headers_response\x18\r\x20\x01(\x0b2\x1d.network.BlockHeadersR\
    esponseH\0R\x14blockHeadersResponse\x12<\n\rblock_request\x18\x0e\x20\
    \x01(\x0b2\x15.network.BlockRequestH\0R\x0cblockRequest\x12?\n\x0eblock_\
    response\x18\x0f\x20\x01(\x0b2\x16.network.BlockResponseH\0R\rblockRespo\
    nse\x12>\n\x0btransaction\x18\x10\x20\x01(\x0b2\x1a.network.SignedTransa\
    ctionH\0R\x0btransaction\x120\n\x06routed\x18\x11\x20\x01(\x0b2\x16.netw\
    ork.RoutedMessageH\0R\x06routed\x125\n\ndisconnect\x18\x12\x20\x01(\x0b2\
    \x13.network.DisconnectH\0R\ndisconnect\x122\n\tchallenge\x18\x13\x20\
    \x01(\x0b2\x12.network.ChallengeH\0R\tchallengeB\x0e\n\x0cmessage_typeJ\
    \x04\x08\x01\x10\x02J\x04\x08\x02\x10\x03J\x04\x08\x03\x10\x04J\x04\x08\
    \x14\x10\x15J\x04\x08\x15\x10\x16J\x04\x08\x16\x10\x17J\x04\x08\x17\x10\
    \x18J\x04\x08\x18\x10\x19b\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(AdvertisedPeerDistance::generated_message_descriptor_data());
            messages.push(DistanceVector::generated_message_descriptor_data());
